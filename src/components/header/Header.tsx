      ...
      <HeaderWrapper className={clsx(className)}>
        <StyledContainer>
          <FlexBetween width="100%">
            ...
            {/* MIDDLE CONTENT - LOGO */}
            <Link href="/">
              <Image height={44} src="/assets/images/livemeLogo.webp" alt="logo" />
            </Link>
            ...
            <FlexBox justifyContent="end" flex={1}>
              ...
              <Box component={IconButton} onClick={session?.user.id ? () => router.push('/profile') : toggleDialog}>
    ...
    <HeaderWrapper className={clsx(className)}>
      <StyledContainer>
        ...
        <FlexBox gap={1.5} alignItems="center">
          ...
          <Box component={IconButton} p={1.25} bgcolor="grey.200" onClick={session?.user.id ? () => router.push('/profile') : toggleDialog}>
            <PersonOutline />
          </Box>
          ...
          <Badge badgeContent={state.cart.length} color="primary">
            ...
            {session?.user.id &&  <Box p={1.25} bgcolor="grey.200" component={IconButton} onClick={logout}>
              <LogoutIcon />
            </Box>}
